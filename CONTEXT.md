...
**SYLVANIA - THE CURSED COUNTY (20/09/2026, non teste par Nono)** : `DATABASE/WFRP4/BOOK_SYLVANIA_THE_CURSED_COUNTY.Xml` (code `SYLVA`, `COMPLETE=0`), ajoute a `BOOKWFRP4` de `INI.TXT`. Saisis : 2 armes (`SYLVA-PROJ_ARB_01` Catechist Heavy Crossbow, `SYLVA-COMB_BASE_01` Catechist Stake), 11 objets d'auberge (suffixe « (Sylvania) »), 10 Drakenhof Sundries, 3 bateaux fluviaux (`SYLVA-TRAP_022` a `_024`, Theme `RULES-LAB_195`, Price + Carries, stats en commentaire, Enc 0). Conversions : d = SB, / = PA, GC = CO, Scare = Limited. A verifier : Catechist Stake (portee lue `WEAPR_PERSO`, degats `-`). Non saisis : PNJ, tables d'evenements. Les bateaux attendent le chantier vehicules (qualite Crewed).
