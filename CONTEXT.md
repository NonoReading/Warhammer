...
**ACCESSOIRES D ARME (19/09/2026, valide par Nono, commit ef9596b)** : voir §2 « Un accessoire est une fabrication » (`RangeBonus`, `WeaponQuality`, Accurate +10%). Bayonet fait le 20/09/2026 (balise `<AlternateWeapon>`, ligne Spear en plus sur le PDF). Reste : affichage WinPersonnage. Decisions du jour : « porte par » et groupes en pause (bonus d encombrement des montures conserve) ; creatures adverses (Frostfiend, Djinn) non gerees ; Nations of Mankind = livre de fan (OFFICIAL=2, confirme).
