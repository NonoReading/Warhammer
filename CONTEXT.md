...
**ADAPTING CAREERS (20/09/2026, compile, substitutions imposees validees par Nono)** : voir 2.85 plus bas et `A FAIRE.txt` (section HIGH ELF, RESTE en 5 points). Point de reprise : brancher `StandingAdaptation` (Warden, Entertainer), puis l affichage.
...
Valide sur les sauvegardes 3 et 4 (Ellyrion Cavalryman : Track a la place de Blackpowder au niveau 2). NON fait : Standing, affichage (colonne de niveau, WinMetier, PDF, tableau de creation niveau 1), trappings, facultatives (champ de fiche), options Up in Arms.
