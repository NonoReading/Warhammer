...
**Reste** (A FAIRE.txt) : noms de famille nobles (« von ») et patronymes humains ; Sea Elf (High Elf Player s Guide : generateur haut elfe + 9 epithetes) ; ethnies sans donnee (Bretonniens, Kislevites...) retombent sur le Reiklandais ; V5 sans bloc de noms.
