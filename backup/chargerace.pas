...
Function CheminRaceImage(CodeRace: String; Indice: String): String;
  ...
  begin
    for PRace in ListRace do
      if CompareRechercheValeur(PRace.CodeRace, CodeRace) then
        Begin
          ResTrans := GetCurrentDir+StringReplace(ConstCheminImageRace, ConstLivre, PRace.Livre, [rfReplaceAll])+CodeRace+Indice+ConstTransparent+'.PNG';
          ResNormal:= GetCurrentDir+StringReplace(ConstCheminImageRace, ConstLivre, PRace.Livre, [rfReplaceAll])+CodeRace+Indice+'.PNG';
